...
impl<'de> Deserialize<'de> for ChatCompletionRequest {
        ...
        D: Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("CompletionRequest", FIELDS, ChatCompletionRequestVisitor)
    }
}
...
//             fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
//                 formatter.write_str("struct ChatCompletionMessage")
//             }
